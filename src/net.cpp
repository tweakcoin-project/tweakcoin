...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "TweakCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"tweakcoin.net", "node1.tweakcoin.net"},
    {"tweakcoin.net", "node2.tweakcoin.net"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. TweakCoin is probably already running."), addrBind.ToString().c_str());
        else
